title: ImageResizer OEM License
textclass: t legal
Libs: -comments
...
Design and approval of a scope agreement is completely at our discretion. Please contact support@imageresizing.net to discuss your specific scope needs *prior* to checkout. 
    ...
    OEM Scope Agreement between Fictional Acme Corporation and Imazen LLC
    ...
    1. Major releases of the Work will be included as long as the support 
       ...
       require a newer revision of the OEM license to be used, which may (in
       some cases) require that updated license terms be distributed to 
       third parties with the new version. Any subsequent minor updates to 
       an included major release are automatically included.
    
    2. This OEM License only permits redistribution and resale as part of the
    ...
    3. The Work covered by this license includes all ImageResizer plugins 
       ...
       Enterprise license.
    4. The Larger Project which includes the Work shall not be sold
       or licensed for a lower price that that part of the Work is available
       for separately from the Licensor.
...
* “Scope Agreement” shall define the context and products in which the Work (or a Derivative Work) may be redistributed. It shall also define which software components and which versions of those components shall compose the Work licensed to You under these terms. To be valid, a Scope Agreement must be approved in writing by an authorized representative of the Licensor.
...
A Scope Agreement defines what the Licensed Work is, which versions are included, and whether major or minor upgrades are included.
