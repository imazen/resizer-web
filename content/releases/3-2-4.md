...
* Fixed bug in ImageBuilder.TranslatePoints() that causes incorrect result coordiantes when the image is being cropped. This method is infrequently used, and this bug would not affect image results.
...
* Plugins now redact any sensitive information from the /resizer.debug diagnostics page, to proctect users who have set CustomErrors=Off.
